                                                   ...
                                                   _udp(LOWLEVEL), customcommunication(8070)
{
    ...
    // kd_command.open("kd_at_IOSDK.txt");
    count = 0;
}
...
//     state->motorState[1].q = decodedState.leg_motor1.q;
//     state->motorState[1].dq = decodedState.leg_motor1.dq;
//     state->motorState[1].tauEst = decodedState.leg_motor1.tauEst;

//     state->motorState[2].q = decodedState.leg_motor2.q;
//     state->motorState[2].dq= decodedState.leg_motor2.dq;
//     state->motorState[2].tauEst = decodedState.leg_motor2.tauEst;

//     state->motorState[3].q = decodedState.leg_motor3.q;
//     state->motorState[3].dq= decodedState.leg_motor3.dq;
//     state->motorState[3].tauEst = decodedState.leg_motor3.tauEst;

//     state->motorState[4].q = decodedState.leg_motor4.q;
//     state->motorState[4].dq = decodedState.leg_motor4.dq;
//     state->motorState[4].tauEst = decodedState.leg_motor4.tauEst;

//     state->motorState[5].q = decodedState.leg_motor5.q;
//     state->motorState[5].dq= decodedState.leg_motor5.dq;
//     state->motorState[5].tauEst = decodedState.leg_motor5.tauEst;

//     state->motorState[6].q = decodedState.leg_motor6.q;
//     state->motorState[6].dq= decodedState.leg_motor6.dq;
//     state->motorState[6].tauEst = decodedState.leg_motor6.tauEst;

//     state->motorState[7].q = decodedState.leg_motor7.q;
//     state->motorState[7].dq= decodedState.leg_motor7.dq;
//     state->motorState[7].tauEst = decodedState.leg_motor7.tauEst;

//     state->motorState[8].q = decodedState.leg_motor8.q;
//     state->motorState[8].dq= decodedState.leg_motor8.dq;
//     state->motorState[8].tauEst = decodedState.leg_motor8.tauEst;

//     state->motorState[9].q = decodedState.leg_motor9.q;
//     state->motorState[9].dq= decodedState.leg_motor9.dq;
//     state->motorState[9].tauEst = decodedState.leg_motor9.tauEst;

//     state->motorState[10].q = decodedState.leg_motor10.q;
//     state->motorState[10].dq= decodedState.leg_motor10.dq;
//     state->motorState[10].tauEst = decodedState.leg_motor10.tauEst;

//     state->motorState[11].q = decodedState.arm_motor1.q;
//     state->motorState[11].dq= decodedState.arm_motor1.dq;
//     state->motorState[11].tauEst = decodedState.arm_motor1.tauEst;

//     // std::cout << "Arm motor 1 state q is" << state->motorState[11].q << std::endl;

//     state->motorState[12].q = decodedState.arm_motor2.q;
//     state->motorState[12].dq= decodedState.arm_motor2.dq;
//     state->motorState[12].tauEst = decodedState.arm_motor2.tauEst;
...
//     state->motorState[15].q = decodedState.arm_motor5.q;
//     state->motorState[15].dq= decodedState.arm_motor5.dq;
//     state->motorState[15].tauEst = decodedState.arm_motor5.tauEst;

//     state->motorState[16].q = decodedState.arm_motor6.q;
//     state->motorState[16].dq= decodedState.arm_motor6.dq;
//     state->motorState[16].tauEst = decodedState.arm_motor6.tauEst;

//     state->motorState[17].q = decodedState.arm_motor7.q;
//     state->motorState[17].dq= decodedState.arm_motor7.dq;
//     state->motorState[17].tauEst = decodedState.arm_motor7.tauEst;
...
//     // Arm Motor Assigning
//     // message_to_encode.leg_motor1.q = cmd->motorCmd[1].q;
//     // message_to_encode.leg_motor1.dq = cmd->motorCmd[1].dq;
//     // message_to_encode.leg_msotor1.kp = cmd->motorCmd[1].Kp;
//     // message_to_encode.leg_motor1.kd = cmd->motorCmd[1].tau;

//     // message_to_encode.leg_motor2.q = cmd->motorCmd[2].q;
//     // message_to_encode.leg_motor2.dq = cmd->motorCmd[2].dq;
//     // message_to_encode.leg_motor2.kp = cmd->motorCmd[2].Kp;
//     // message_to_encode.leg_motor2.kd = cmd->motorCmd[2].tau;

//     message_to_encode.leg_motor3.q = cmd->motorCmd[3].q;
//     message_to_encode.leg_motor3.dq = cmd->motorCmd[3].dq;
//     message_to_encode.leg_motor3.kp = cmd->motorCmd[3].Kp;
//     message_to_encode.leg_motor3.kd = cmd->motorCmd[3].tau;

//     message_to_encode.leg_motor4.q = cmd->motorCmd[4].q;
//     message_to_encode.leg_motor4.dq = cmd->motorCmd[4].dq;
//     message_to_encode.leg_motor4.kp = cmd->motorCmd[4].Kp;
//     message_to_encode.leg_motor4.kd = cmd->motorCmd[4].tau;

//     message_to_encode.leg_motor5.q = cmd->motorCmd[5].q;
//     message_to_encode.leg_motor5.dq = cmd->motorCmd[5].dq;
//     message_to_encode.leg_motor5.kp = cmd->motorCmd[5].Kp;
//     message_to_encode.leg_motor5.kd = cmd->motorCmd[5].tau;

//     message_to_encode.leg_motor6.q = cmd->motorCmd[6].q;
//     message_to_encode.leg_motor6.dq = cmd->motorCmd[6].dq;
//     message_to_encode.leg_motor6.kp = cmd->motorCmd[6].Kp;
//     message_to_encode.leg_motor6.kd = cmd->motorCmd[6].tau;

//     message_to_encode.leg_motor7.q = cmd->motorCmd[7].q;
//     message_to_encode.leg_motor7.dq = cmd->motorCmd[7].dq;
//     message_to_encode.leg_motor7.kp = cmd->motorCmd[7].Kp;
//     message_to_encode.leg_motor7.kd = cmd->motorCmd[7].tau;

//     message_to_encode.leg_motor8.q = cmd->motorCmd[8].q;
//     message_to_encode.leg_motor8.dq = cmd->motorCmd[8].dq;
//     message_to_encode.leg_motor8.kp = cmd->motorCmd[8].Kp;
//     message_to_encode.leg_motor8.kd = cmd->motorCmd[8].tau;

//     message_to_encode.leg_motor9.q = cmd->motorCmd[9].q;
//     message_to_encode.leg_motor9.dq = cmd->motorCmd[9].dq;
//     message_to_encode.leg_motor9.kp = cmd->motorCmd[9].Kp;
//     message_to_encode.leg_motor9.kd = cmd->motorCmd[9].tau;

//     message_to_encode.leg_motor10.q = cmd->motorCmd[10].q;
...
//     message_to_encode.arm_motor1.kp = cmd->motorCmd[11].Kp;
//     message_to_encode.arm_motor1.kd = cmd->motorCmd[11].Kd;
//     message_to_encode.arm_motor1.tau = cmd->motorCmd[11].tau;
//     // std::cout << "Arm1 kd is " << cmd->motorCmd[11].Kd;

//     message_to_encode.arm_motor2.q = cmd->motorCmd[12].q;
//     message_to_encode.arm_motor2.dq = cmd->motorCmd[12].dq;
//     message_to_encode.arm_motor2.kp = cmd->motorCmd[12].Kp;
//     message_to_encode.arm_motor2.kd = cmd->motorCmd[12].Kd;
//     message_to_encode.arm_motor2.tau = cmd->motorCmd[12].tau;
//     // std::cout << "Arm2 kd is " << cmd->motorCmd[12].Kd;

//     message_to_encode.arm_motor3.q = cmd->motorCmd[13].q;
//     message_to_encode.arm_motor3.dq = cmd->motorCmd[13].dq;
//     message_to_encode.arm_motor3.kp = cmd->motorCmd[13].Kp;
//     message_to_encode.arm_motor3.kd = cmd->motorCmd[13].Kd;
//     message_to_encode.arm_motor3.tau = cmd->motorCmd[13].tau;

//     message_to_encode.arm_motor4.q = cmd->motorCmd[14].q;
//     message_to_encode.arm_motor4.dq = cmd->motorCmd[14].dq;
//     message_to_encode.arm_motor4.kp = cmd->motorCmd[14].Kp;
//     message_to_encode.arm_motor4.kd = cmd->motorCmd[14].Kd;
//     message_to_encode.arm_motor4.tau = cmd->motorCmd[14].tau;

//     message_to_encode.arm_motor5.q = cmd->motorCmd[15].q;
//     message_to_encode.arm_motor5.dq = cmd->motorCmd[15].dq;
//     message_to_encode.arm_motor5.kp = cmd->motorCmd[15].Kp;
//     message_to_encode.arm_motor5.kd = cmd->motorCmd[15].Kd;
//     message_to_encode.arm_motor5.tau = cmd->motorCmd[15].tau;

//     message_to_encode.arm_motor6.q = cmd->motorCmd[16].q;
//     message_to_encode.arm_motor6.dq = cmd->motorCmd[16].dq;
//     message_to_encode.arm_motor6.kp = cmd->motorCmd[16].Kp;
//     message_to_encode.arm_motor6.kd = cmd->motorCmd[16].Kd;
//     message_to_encode.arm_motor6.tau = cmd->motorCmd[16].tau;

//     message_to_encode.arm_motor7.q = cmd->motorCmd[17].q;
//     message_to_encode.arm_motor7.dq = cmd->motorCmd[17].dq;
//     message_to_encode.arm_motor7.kp = cmd->motorCmd[17].Kp;
//     message_to_encode.arm_motor7.kd = cmd->motorCmd[17].Kd;
//     message_to_encode.arm_motor7.tau = cmd->motorCmd[17].tau;

//     message_to_encode.arm_motor8.q = cmd->motorCmd[18].q;
//     message_to_encode.arm_motor8.dq = cmd->motorCmd[18].dq;
//     message_to_encode.arm_motor8.kp = cmd->motorCmd[18].Kp;
//     message_to_encode.arm_motor8.kd = cmd->motorCmd[18].Kd;
//     message_to_encode.arm_motor8.tau = cmd->motorCmd[18].tau;

//     message_to_encode.leg_motor1.mode = 10;
//     message_to_encode.leg_motor1.q = 0.0;
//     message_to_encode.leg_motor1.dq = 0.0;
//     message_to_encode.leg_motor1.kp = 0.0;
//     message_to_encode.leg_motor1.kd = 5.0;
//     message_to_encode.leg_motor1.tau = 0.0;

//     message_to_encode.leg_motor2.mode = 10;
//     message_to_encode.leg_motor2.q = 0.0;
//     message_to_encode.leg_motor2.dq = 0.0;
//     message_to_encode.leg_motor2.kp = 0.0;
//     message_to_encode.leg_motor2.kd = 5.0;
//     message_to_encode.leg_motor2.tau = 0.0;

//     message_to_encode.leg_motor3.mode = 10;
//     message_to_encode.leg_motor3.q = 0.0;
//     message_to_encode.leg_motor3.dq = 0.0;
//     message_to_encode.leg_motor3.kp = 0.0;
//     message_to_encode.leg_motor3.kd = 5.0;
//     message_to_encode.leg_motor3.tau = 0.0;

//     message_to_encode.leg_motor4.mode = 10;
//     message_to_encode.leg_motor4.q = 0.0;
//     message_to_encode.leg_motor4.dq = 0.0;
//     message_to_encode.leg_motor4.kp = 0.0;
//     message_to_encode.leg_motor4.kd = 1.0;
//     message_to_encode.leg_motor4.tau = 0.0;

//     message_to_encode.leg_motor5.mode = 10;
//     message_to_encode.leg_motor5.q = 0.0;
//     message_to_encode.leg_motor5.dq = 6.28;
//     message_to_encode.leg_motor5.kp = 0.0;
//     message_to_encode.leg_motor5.kd = 1.0;
//     message_to_encode.leg_motor5.tau = 0.0;

//     message_to_encode.leg_motor6.mode = 10;
//     message_to_encode.leg_motor6.q = 0.0;
//     message_to_encode.leg_motor6.dq = 6.28;
//     message_to_encode.leg_motor6.kp = 0.0;
//     message_to_encode.leg_motor6.kd = 1.0;
//     message_to_encode.leg_motor6.tau = 0.0;

//     message_to_encode.leg_motor7.mode = 10;
//     message_to_encode.leg_motor7.q = 0.0;
//     message_to_encode.leg_motor7.dq = 6.28;
//     message_to_encode.leg_motor7.kp = 0.0;
//     message_to_encode.leg_motor7.kd = 1.0;
//     message_to_encode.leg_motor7.tau = 0.0;

//     message_to_encode.leg_motor8.mode = 10;
//     message_to_encode.leg_motor8.q = 0.0;
//     message_to_encode.leg_motor8.dq = 6.28;
//     message_to_encode.leg_motor8.kp = 0.0;
//     message_to_encode.leg_motor8.kd = 1.0;
//     message_to_encode.leg_motor8.tau = 0.0;

//     auto encoded_message = customcommunication.encodeLowLevelCmd(message_to_encode);

//     customcommunication.sendUdpMessage(encoded_message, "192.168.123.178", 8080);
//     std::cout << "Sent" << std::endl;
// }